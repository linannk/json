...
bool JsonValue::parseFromCharSeq(JsonInputStream &charSeq)
{
    try {
        JsonValue tmpValue;
...
void JsonValue::parseJsonValue(JsonInputStream &charSeq)
{
    char c = 0;
        ...
        case JSON_QUOTE: {
            ...
            for (;;) {
                ...
                if (c == '\\') {
                    ...
                    str.push_back(c);
                    const int char_count = charSeq.json_char_count(c);
